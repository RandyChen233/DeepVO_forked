...
class Parameters():
	def __init__(self):
		self.n_processors = 6
		# Path
		self.data_dir =  '/mnt/d/DeepVO-pytorch/KITTI/'
		...
		# self.save_optimizer_path = 'models/t000102050809_v04060710_im184x608_s5x7_b8_rnn1000_optAdagrad_lr0.0005.optimizer'
